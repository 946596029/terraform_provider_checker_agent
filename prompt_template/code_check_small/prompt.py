...
def build_code_check_small_prompt() -> ChatPromptTemplate:
    """Build the code check small prompt template.
...
code_check_small_prompt = build_code_check_small_prompt()

__all__ = ["code_check_small_prompt"]